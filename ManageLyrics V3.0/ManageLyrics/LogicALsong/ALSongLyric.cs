...
public class ALSongLyric
{
    ...
    /// <summary>
    /// Gets lyric list of music
    /// </summary>
    /// <param name="aArtist"></param>
    /// <param name="aTitle"></param>
    /// <returns></returns>
    public List<LyricBasicInfo> GetLyricsSearch(string Artist, string Title)
    {
        XmlDocument xmlDocument = RequestLyList(A + B, D, Title, Artist);
    ...
    /// <summary>
    /// It make listitem text of title, artist, album, request id
    /// </summary>
    ...
    /// <returns></returns>
    public XmlDocument RequestLyList(string A_B, string D, string Artist, string Title)
    {
        XmlDocument? xmlDocument1 = null;
        string str = A_B.Replace("^^", "\"").Replace("TITLE", Artist).Replace("ARTIST", Title).Replace("ENCDATA", EncData);
        WebRequest webRequest;
        try
        {
            webRequest = WebRequest.Create(D);
    ...
    /// Get lyric from id
    /// </summary>
    /// <param name="LyricID"></param>
    /// <returns></returns>
    public LyricInfo GetLyricFromID(int LyricID)
    {
    ...
    /// <summary>
    /// Request post for lyric
    /// </summary>
    /// <param name="A_C"></param>
    /// <param name="D"></param>
    /// <returns></returns>
    public static XmlDocument RequestLyric(string A_C, string D)
    {
        XmlDocument xmlDocument1 = (XmlDocument)null;
        string str = A_C.Replace("^^", "\"");
    ...
    /// <summary>
    /// Gets lyric detail of lyric information
    /// </summary>
    ...
    public static LyricInfo GetLyricDetail(XmlDocument Xml)
    {
        ...
        if (!(childNodes[0].Name == "GetLyric7Result")) return (LyricInfo)null;
